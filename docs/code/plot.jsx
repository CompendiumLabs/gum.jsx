...
return <Plot aspect={phi} xanchor={0} xticks={xticks} grid xlabel="phase" ylabel="amplitude" title="Inverted Sine Wave" xaxis-tick-side="both" grid-stroke-dasharray={3} margin={0.25}>
