...
<Network coord={[0, 0, 2, 1]} node-rad={[0.2, 0.1]} aspect={phi}>
  <Node label="hello world" pos={[0.4, 0.5]} rad={[0.25, 0.15]} fill>{"Hello\nworld!"}</Node>
  <Node label="hello" pos={[1.4, 0.25]} fill>Hello</Node>
  <Node label="world" pos={[1.6, 0.75]} fill>World!</Node>
